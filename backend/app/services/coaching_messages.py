...
RECOMMENDATION_REASON: Dict[str, str] = {
    ...
    "session": "{label} was your lowest-scoring criterion today -- not enough history yet to confirm a pattern.",
}

ACTIONABLE_IMPROVEMENT: Dict[str, str] = {
    "history": "Spend your next practice session focused specifically on {label} -- it keeps coming up as your lowest-scoring criterion across recent sessions.",
    "session": "Spend your next practice session focused specifically on {label} -- it was your lowest-scoring criterion today.",
}
