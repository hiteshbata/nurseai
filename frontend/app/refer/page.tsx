    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {loading || !info ? (
          ...
          <>
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0F2356] to-[#1A3A73] shadow-lg p-8 mb-6">
              <div
              ...
              <div className="relative flex flex-col items-center text-center gap-3">
                ...
                <div className="mt-2 flex w-full items-center gap-2">
                  <input
                    ...
                    className="h-11 flex-1 truncate rounded-xl border border-white/10 bg-white/5 px-3.5 text-sm text-white/90 outline-none"
                  />
                  <button
                    onClick={handleCopy}
                    className="flex h-11 shrink-0 items-center gap-1.5 rounded-xl bg-emerald-500 px-4 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-emerald-600 active:scale-[0.99]"
                  >
