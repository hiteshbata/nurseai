  ...
  return (
    <RevealOnScroll>
      <div className="mt-12 rounded-3xl bg-[#0F2356] px-8 py-12 text-center shadow-premium">
        ...
        <Link
          href={href}
          className="inline-flex items-center justify-center bg-[#047857] text-white font-semibold px-7 py-3.5 rounded-xl hover:bg-[#036546] hover:shadow-premium-lg motion-safe:transition-all motion-safe:duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F2356]"
        >
          {label}
        </Link>
      </div>
