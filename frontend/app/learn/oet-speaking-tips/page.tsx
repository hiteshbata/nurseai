...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/learn/oet-speaking-tips' },
}
  ...
  return (
    <main className="min-h-screen px-4 py-20 max-w-3xl mx-auto">
      ...
      <div className="motion-safe:animate-[fade-up-in_0.5s_ease-out_both]">
        <h1 className="font-display text-3xl font-semibold text-[#0F2356] mt-4 mb-4">OET Speaking Tips for Nurses</h1>
      ...
      <h2 id="tip-1-use-prep-well" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">1. Use your 2 minutes of prep well</h2>
      ...
      <h2 id="tip-2-open-the-conversation" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">2. Open the conversation, don&apos;t launch into facts</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="tip-3-give-structure" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">3. Give the conversation structure</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="tip-4-check-understanding" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">4. Check understanding before moving on</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="tip-5-react-to-patient" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">5. React to what the patient actually says</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="tip-6-record-yourself" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">6. Record yourself and listen back</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="tip-7-practise-roleplay" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">7. Practise the roleplay itself, not just vocabulary</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
