...
export default function OetListeningPillarPage() {
  return (
    <main className="min-h-screen px-4 py-20 max-w-3xl mx-auto">
      ...
      {/* ---------------------------------------------------------- */}
      <h2 id="what-is-oet-listening" className="font-display text-2xl font-semibold text-[#0F2356] mt-10 mb-4">
      ...
      {/* ---------------------------------------------------------- */}
      <h2 id="how-listening-is-scored" className="font-display text-2xl font-semibold text-[#0F2356] mt-10 mb-4">
      ...
      <h3 className="font-display text-lg font-semibold text-[#0F2356] mt-8 mb-2">1. Part A — real-time note-taking</h3>
      ...
      <h3 className="font-display text-lg font-semibold text-[#0F2356] mt-8 mb-2">2. Part A — catching self-corrections</h3>
      <p className="text-gray-600 leading-relaxed mb-3">
      ...
      <h3 className="font-display text-lg font-semibold text-[#0F2356] mt-8 mb-2">3. Part B — purpose from a single hearing</h3>
      <p className="text-gray-600 leading-relaxed mb-3">
      ...
      <h3 className="font-display text-lg font-semibold text-[#0F2356] mt-8 mb-2">4. Part C — attitude, opinion, and emphasis</h3>
      <p className="text-gray-600 leading-relaxed mb-3">
      ...
      <h3 className="font-display text-lg font-semibold text-[#0F2356] mt-6 mb-2">Decision tree: fell behind mid-recording?</h3>
      <RevealOnScroll>
      ...
      <RevealOnScroll>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2 mb-4 text-sm">
          ...
          <Link href="/practice/mock" className={relatedLinkClass}>
