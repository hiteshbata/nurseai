...
export default function OetVsIeltsPage() {
  return (
    <main className="min-h-screen px-4 py-20 max-w-3xl mx-auto">
      ...
      <h2 id="the-core-difference" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">The core difference</h2>
      ...
      <h2 id="format-side-by-side" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">Format, side by side</h2>
      <RevealOnScroll>
      ...
      <h2 id="why-nurses-prefer-oet" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">Why many nurses prefer OET</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="how-to-decide" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">How to decide</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
