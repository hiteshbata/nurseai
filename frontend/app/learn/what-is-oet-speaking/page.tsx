  ...
  return (
    <main className="min-h-screen px-4 py-20 max-w-3xl mx-auto">
      ...
      <div className="motion-safe:animate-[fade-up-in_0.5s_ease-out_both]">
        <h1 className="font-display text-3xl font-semibold text-[#0F2356] mt-4 mb-4">What is OET Speaking?</h1>
      ...
      <h2 id="the-format" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">The format</h2>
      ...
      <h2 id="whats-being-assessed" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">What&apos;s being assessed</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <h2 id="why-it-feels-different" className="font-display text-xl font-semibold text-[#0F2356] mt-8 mb-3">Why it feels different from other exams</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
