      ...
      <div className="max-w-4xl mx-auto">
        ...
        {mistakes.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-lg shadow mt-8">
            ...
            <p className="text-gray-400">Take a listening test and anything you get wrong will show up here for review.</p>
          </div>
        ) : (
          <div className="space-y-6 mt-8">
            {mistakes.map((m) => (
              <Card key={m.questionId} className="p-6">
                {m.section_title && (
                  <span className="text-xs font-semibold text-gray-400 uppercase tracking-wide">{m.section_title}</span>
                )}
